...
import { getCategories, createCategory, updateCategory, deleteCategory, createAdminCategory, updateAdminCategory, deleteAdminCategory, getAdminCategories } from '../controllers/category.controller';
...
router.get('/admin', authorizeAdmin, getAdminCategories);
